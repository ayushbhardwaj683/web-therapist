        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          <div className="order-1 md:order-2 w-full flex justify-center md:justify-end">
            <ScrollAnimator delay={100}>
              <div className="relative w-full md:max-w-md h-[500px] md:h-[700px] rounded-t-[10rem] md:rounded-t-full rounded-b-none overflow-hidden border border-[#3B3632]/10 shadow-xl md:translate-x-6">
